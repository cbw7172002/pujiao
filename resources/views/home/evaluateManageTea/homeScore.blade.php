                                ...
                                <div class="student_paper_content_repeat_cen_answer">
                                    ...
                                    <div class="question_detail_score">
                                        <div class="question_detail_score_top">
                                            评分：<input type="text" ms-duplex-num="a.getScore" /> 分
                                        </div>
...
@section('js')
    <script>
        require(['/evaluateManageTea/homeScore'], function (stuPaperStu) {
            stuPaperStu.paperId = '{{$id}}' || null;
            stuPaperStu.userId = '{{$userId}}' || null;
            stuPaperStu.init();
            stuPaperStu.getData('/evaluateManageTea/getHomeScore/' + stuPaperStu.paperId + '/' + stuPaperStu.userId, 'GET', '', 'paperInfo');
