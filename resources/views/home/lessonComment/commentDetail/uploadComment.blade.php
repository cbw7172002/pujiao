		...
		<div class="uploadComment_content">
			...
			<div class="score">
				...
				<div class="bot" name="a">
					...
					<span class="star no-light" ms-click="addScore('a',1);" onclick="turnLight(this);"></span>
					<span class="star no-light" ms-click="addScore('a',2);" onclick="turnLight(this);"></span>
					<span class="star no-light" ms-click="addScore('a',3);" onclick="turnLight(this);"></span>
					<span class="star no-light" ms-click="addScore('a',4);" onclick="turnLight(this);"></span>
					<span class="star no-light" ms-click="addScore('a',5);" onclick="turnLight(this);"></span>
					<div class="right" ms-text="scoreStyle[uploadInfo.aNum - 1]"></div>
				</div>
				<div class="bot" name="b">
					<div class="left">内容设计</div>
					<span class="star no-light" ms-click="addScore('b',1);" onclick="turnLight(this);"></span>
					<span class="star no-light" ms-click="addScore('b',2);" onclick="turnLight(this);"></span>
					<span class="star no-light" ms-click="addScore('b',3);" onclick="turnLight(this);"></span>
					<span class="star no-light" ms-click="addScore('b',4);" onclick="turnLight(this);"></span>
					<span class="star no-light" ms-click="addScore('b',5);" onclick="turnLight(this);"></span>
					<div class="right" ms-text="scoreStyle[uploadInfo.bNum - 1]"></div>
				</div>
				<div class="bot" name="c">
					<div class="left">学习方式</div>
					<span class="star no-light" ms-click="addScore('c',1);" onclick="turnLight(this);"></span>
					<span class="star no-light" ms-click="addScore('c',2);" onclick="turnLight(this);"></span>
					<span class="star no-light" ms-click="addScore('c',3);" onclick="turnLight(this);"></span>
					<span class="star no-light" ms-click="addScore('c',4);" onclick="turnLight(this);"></span>
					<span class="star no-light" ms-click="addScore('c',5);" onclick="turnLight(this);"></span>
					<div class="right" ms-text="scoreStyle[uploadInfo.cNum - 1]"></div>
				</div>
				<div class="bot" name="d">
					<div class="left">配套器具</div>
					<span class="star no-light" ms-click="addScore('d',1);" onclick="turnLight(this);"></span>
					<span class="star no-light" ms-click="addScore('d',2);" onclick="turnLight(this);"></span>
					<span class="star no-light" ms-click="addScore('d',3);" onclick="turnLight(this);"></span>
					<span class="star no-light" ms-click="addScore('d',4);" onclick="turnLight(this);"></span>
					<span class="star no-light" ms-click="addScore('d',5);" onclick="turnLight(this);"></span>
