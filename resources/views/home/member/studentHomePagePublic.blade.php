...
@section('title', '学生个人主页--公开')

@section('css')
    <link rel="stylesheet" type="text/css" href="{{asset('home/css/personCenter/studentHomePagePublic.css')}}">
...
@section('content')
    ...
    <div class="h40"></div>
    <div class="container" ms-controller="studentHomePagePublic">
        <!--主体上方个人介绍-->
            ...
            <div class="introduce_left">
                <div class="introduce_left_top">
                    ...
                    <div class="introduce_left_top_right">
                        ...
                        @if(Auth::check())
                            @if($mineId != $hisId)
                                <div class="introduce_left_top_right_right" id="follow" ms-follow="isFollow" ms-click="followUser()"></div>
                            @else
                                <div id="follow" class="introduce_left_top_right_right isFollow" style="background: none !important;cursor: default;"></div>
                            @endif
                        @else
                            <a href="/index/login" id="follow" class="introduce_left_top_right_right" ms-follow="isFollow"></a>
                        @endif
                    </div>
                </div>
                ...
                <div class="introduce_left_bottom">
                    ...
                    <div class="introduce_left_bottom_location" ms-html="userInfo.school || '暂无'"></div>
        ...
        <div class="center_left">
            ...
            <div class="account_common" name="studentCourse" ms-click="changeTab('studentCourse')">在学课程</div>
            <span class="span_hover"></span>
            <div class="account_common" name="studentAnswer" ms-click="changeTab('studentAnswer')">他的问答</div>
            <span class="span_hover"></span>
        ...
        <!--主体右边   教师课程开始-->
        <div class="center_right hide" ms-visible="tabStatus === 'studentCourse'" ms-controller="studentCourseController">
            <div class="right_course_list">
                <div class="course_list">课程列表</div>
            </div>
            <div class="resource_content">
                <!--repeat开始-->
                <div class="resource_content_repeat" ms-repeat="studentCourseInfo">
                    <div class="resource_repeat_left">
                        <img ms-attr-src="el.coursePic"  alt="" width="120" height="90">
                    </div>

                    <div class="resource_repeat_right">
                        <div class="resource_repeat_right_first" ms-html="el.courseTitle">单词和句子</div>
            ...
            <div ms-visible="stuCourseMsg" class="warningMsg">暂无课程...</div>
        ...
        <!--主体右边   教师问答开始-->
        <div class="center_right hide" ms-visible="tabStatus === 'studentAnswer'" ms-controller="studentAnswerController" >
            <div class="right_wait_answer">
                <div class="answer_title">问答列表</div>
            </div>
            {{--内容--}}
            <div class="right_wait_answer_content">
                {{--循环内容--}}
                <div class="content_every" ms-repeat="studentAnswerInfo">
            ...
            <div ms-visible="stuAnswerMsg" class="warningMsg">暂无问答...</div>
            <div ms-if="page" class="pagecon_parent" style="margin-top:40px;">
                <div class="pagecon">
                    <div id="page_question"></div>
                </div>
        ...
        <div class="center_right hide" ms-visible="tabStatus === 'HisFriends'" ms-controller="myFansTeacher">
            ...
            <div class="center_right_focus">
                ...
                <div ms-visible="myFans" class="warningMsg" style="height: 275px;line-height: 275px;">暂无好友...</div>
            </div>
        ...
        <div class="center_right hide" ms-visible="tabStatus === 'HisFocus'" ms-controller="myFocusTeacher">
            ...
            <div class="center_right_focus">
                ...
                <div ms-visible="myFocus" class="warningMsg" style="height: 275px;line-height: 275px;">暂无关注...</div>
            </div>
                <div ms-if="display" class="pagecon_parent">
                    <div class="pagecon">
...
@section('js')
    ...
    <script type="text/javascript">
        require(['/personCenter/directive.js', '/personCenter/studentHomePagePublic.js'], function (directive, studentHomePagePublic) {
            studentHomePagePublic.hisId = '{{$hisId}}' || null;
            studentHomePagePublic.mineId = '{{$mineId}}' || null;

            if (window.location.hash) {
                studentHomePagePublic.tab = window.location.hash.split('#')[1];
            } else {
                studentHomePagePublic.tab = 'studentCourse';
            }

            if (studentHomePagePublic.tab) {
                studentHomePagePublic.tabStatus = studentHomePagePublic.tab;
                studentHomePagePublic.changeTab( studentHomePagePublic.tabStatus, studentHomePagePublic.hisId );
            }

            studentHomePagePublic.getData('/member/getUserInfo/' + studentHomePagePublic.hisId, 'userInfo');
            //是否关注
            studentHomePagePublic.mineId && studentHomePagePublic.getData('/member/followUser', 'isFollow', {table: 'friends', action: 1, data: {fromUserId: studentHomePagePublic.mineId, toUserId: studentHomePagePublic.hisId}}, 'POST');
