...
@section('js')
    <script>
        require(['/evaluateManageStu/stuTestPaperStu'], function (stuTestPaperStu) {
            stuTestPaperStu.paperId = '{{$id}}' || null;
            stuTestPaperStu.userId = '{{$userId}}' || null;
            stuTestPaperStu.init();
            stuTestPaperStu.getData('/evaluateManageStu/getTestPaperStu/' + stuTestPaperStu.paperId + '/' + stuTestPaperStu.userId, 'GET', '', 'testInfo');
            // 答案数字转字母
