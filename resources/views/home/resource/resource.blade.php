    ...
    <div class="contain_resource" ms-controller="rescontroller">
        ...
        <div class="contain_lesson_top">
            <div class="contain_lesson_top_bk">
                ...
                <div class="search">
                    <input type="text" name="search" ms-duplex="selTitle"/><span  style="cursor: pointer;" ms-click="titsearch()">搜索</span>
                </div>
        ...
        <div class="contain_resource_main">
            ...
            <div class="contain_resource_main_left">
                ...
                <div class="contain_resource_main_con">
                    ...
                    <div class="contain_resource_main_con_li" ms-repeat-grade="sideSels" ms-if-loop="selGradeId==0 || grade.id == selGradeId">
                        <div class="contain_resource_main_con_li_tit" ms-clicksel="{type:1,gradeId:grade.id,subjectId:0,editionId:0,bookId:0,chapter:0}">
                        ...
                        <div class="contain_resource_main_con_li_con hide" ms-class-1="dottedbor:$index+1 != sideSels.length"  ms-class-2="hide: grade.id != selGradeId">
                            ...
                            <div class="contain_resource_main_con_li" ms-repeat-subject="grade.subjects" ms-if-loop="selSubjectId==0 || subject.id == selSubjectId">
                                <div class="contain_resource_main_con_li_tit"  ms-clicksel="{type:2,gradeId:grade.id,subjectId:subject.id,editionId:0,bookId:0,chapter:0}">
                                ...
                                <div class="contain_resource_main_con_li_con hide dottedbor" ms-class-1="hide: subject.id != selSubjectId">
                                    ...
                                    <div class="contain_resource_main_con_li" ms-repeat-edition="subject.editions" ms-if-loop="selEditionId==0 || edition.id == selEditionId">
                                        <div class="contain_resource_main_con_li_tit"  ms-clicksel="{type:3,gradeId:grade.id,subjectId:subject.id,editionId:edition.id,bookId:0,chapter:0}">
                                        ...
                                        <div class="contain_resource_main_con_li_con hide" ms-class-1="dottedbor:$index+1 != subject.editions.length" ms-class-2="hide: edition.id != selEditionId">
                                            ...
                                            <div class="contain_resource_main_con_li" ms-repeat-book="edition.books" ms-if-loop="selBookId==0 || book.id == selBookId">
                                                <div class="contain_resource_main_con_li_tit"  ms-clicksel="{type:4,gradeId:grade.id,subjectId:subject.id,editionId:edition.id,bookId:book.id,chapter:0}">
                                                ...
                                                <div class="contain_resource_main_con_li_con hide" ms-class-1="dottedbor:$index+1 != edition.books.length" ms-class-2="hide: book.id != selBookId">
                                                    ...
                                                    <div class="contain_resource_main_con_li_con_unit" ms-repeat-chapter="book.chapters" ms-attr-title="chapter.chapterName" ms-html="chapter.chapterName" ms-clicksel="{type:6,gradeId:grade.id,subjectId:subject.id,editionId:edition.id,bookId:book.id,chapter:chapter.id}">Uint1</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            {{--拓展资源--}}
                            <div class="contain_resource_main_con_li" ms-if-loop="selSubjectId==0 || isExpand == true">
                                <div class="contain_resource_main_con_li_tit" ms-clicksel="{type:5,gradeId:grade.id}">
            ...
            <div class="contain_resource_main_right">
                ...
                <div style="height: 30px;"></div>
                <div class="pagecon">
                    <div class="clearPageCon" style="display: inline-block"><div id="page"></div></div>
                </div>
        </div>
    </div>
            ...
            avalon.directive("clicksel", {
                init: function (binding) {
                    avalon(binding.element).bind("click",function () {
                        vm.selecting(binding.oldValue.type,binding.oldValue.gradeId,binding.oldValue.subjectId,binding.oldValue.editionId,binding.oldValue.bookId,binding.oldValue.chapter,true)
