        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="{{url('admin/chapter/doEditChapter')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select name="gradeId" id="form-field-1" class="col-xs-10 col-sm-5">
                                    ...
                                    @foreach($grade as $g)
                                        <option value="{{$g->id}}" @if($g->id == $data->gradeId ) selected @endif>{{$g->gradeName}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-9">
                                <select name="subjectId" id="form-field-1" class="col-xs-10 col-sm-5">
                                    ...
                                    @foreach($subject as $s)
                                        <option value="{{$s->id}}" @if($s->id == $data->subjectId ) selected @endif>{{$s->subjectName}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select name="bookId" id="form-field-1" class="col-xs-10 col-sm-5">
                                    ...
                                    @foreach($book as $b)
                                        <option value="{{$b->id}}" @if($b->id == $data->bookId ) selected @endif>{{$b->bookname}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-9">
                                <select name="editionId" id="form-field-1" class="col-xs-10 col-sm-5">
                                    ...
                                    @foreach($edition as $e)
                                        <option value="{{$e->id}}" @if($e->id == $data->editionId ) selected @endif>{{$e->editionName}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        {{--<div class="form-group">--}}
                            ...
                            {{--<div class="col-sm-9">--}}
                                {{--<input  type="text" name="chapterName" id="form-field-1" placeholder="知识点名称" class="col-xs-10 col-sm-5" value="{{$data->chapterName}}" />--}}
