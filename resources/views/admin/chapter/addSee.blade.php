        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="{{url('admin/chapter/doAddSee')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        {{--<div class="form-group">--}}
                            ...
                            {{--<div class="col-sm-9">--}}
                                {{--<input  type="text" name="chapterName[]" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" value="{{old--}}
                                {{--('url')--}}
                                {{--}}" />--}}
                                    {{--<span class="help-inline col-xs-12 col-sm-7">--}}
                                    {{--<label class="middle">--}}
