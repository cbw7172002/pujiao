    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{url('/admin/question/editquestion')}}">后台用户管理</a>
                </li>
                ...
                <div class="col-xs-12">
                    ...
                    <form action="{{url('/admin/question/editsquestion')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        {{--<div class="form-group">--}}
                            ...
                            {{--<div class="col-sm-9">--}}
                                {{--<textarea name="content" id="form-field-2" class="col-xs-10 col-sm-5" cols="30" rows="10" style="resize:none;--}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <td>
                                    <script type="text/javascript" charset="utf-8" src="{{asset('admin/ueditors/ueditor.config.js')}}"></script>
                                    <script type="text/javascript" charset="utf-8" src="{{asset('admin/ueditors/ueditor.all.min.js')}}"> </script>
                                    <script type="text/javascript" charset="utf-8" src="{{asset('admin/ueditors/lang/zh-cn/zh-cn.js')}}"></script>
                                    <script id="editors" name="answer" type="text/plain" style="width:800px;height:350px;">{!! $data->answer
                                    !!}</script>
                                    <script type="text/javascript">
...
//                                        var s=ue.getPlainTxt();
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea name="answer" id="form-field-2" class="col-xs-10 col-sm-5" cols="30" rows="10" style="resize:none;
