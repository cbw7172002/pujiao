                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <form action="{{url('admin/excel/userInfoImport/outstudent')}}" method="post" enctype="multipart/form-data" style="float:right;">
                                    @permission('add.user')
                                ...
                                @permission('add.user')
                                    <a href="{{url('admin/excel/userInfoTemplate/outstudent')}}" class="btn btn-xs btn-info" style="float: right;margin-right:-30px;">
                                        下载导入模板
                                    </a>
                                @endpermission
                                ...
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover center">
                                    ...
                                    @foreach($data as $value)
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle"><a href="{{url('admin/users/show/outstudent/'.$value->id)}}">{{$value->username}}</a></td>
                                            ...
                                            {{--<td style="vertical-align: middle">{{$value->phone ? $value->phone : '暂无'}}</td>--}}
                                            ...
                                            <td style="vertical-align: middle;width:25%">
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    ...
                                                    <a href="{{url('admin/users/editUser/outStudent/'.$value->id)}}"
                                                    ...
                                                    <a href="{{url('admin/users/resetPass/outstudent/'.$value->id)}}"
                                                    ...
                                                    @permission('user.list')
                                                    <a href="{{url('admin/users/show/outstudent/'.$value->id)}}"
