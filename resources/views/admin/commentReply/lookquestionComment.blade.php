    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{url('/admin/commentReply/questionCommentList')}}">问答评论列表</a>
                </li>
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="{{url('admin/commentReply/editsquestionComment')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input  disabled="true" type="text" name="courseTitle" id="form-field-1" placeholder="评论课程" class="col-xs-10 col-sm-5" value="{{$data->qestitle}}" />
                                    <span class="help-inline col-xs-12 col-sm-7">
                                    <label class="middle">
                                        <span class="lbl"></span>
                                    </label>
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-3 col-md-4">
                                <a href="{{url('admin/commentReply/questionCommentList')}}" class="btn btn-info btn-block" style="margin-left: -15px;">
