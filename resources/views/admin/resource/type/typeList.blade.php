    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <div class="col-xs-12">
                ...
                <a href="{{url('admin/resource/addResourceType')}}" class="btn btn-xs btn-info">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                ...
                                                <a href="{{url('/admin/resource/editResourceType/'.$type->id)}}" class="btn btn-xs btn-info">
                                                    <i class="icon-edit bigger-120"></i>
                                                </a>

                                                {{--@permission('')--}}
                                                <a href="{{url('/admin/resource/delResourceType/'.$type->id)}}" style="width:29px" class="btn btn-xs btn-danger" onclick="return confirm('删除后将无法找回,确定要删除吗?');">
