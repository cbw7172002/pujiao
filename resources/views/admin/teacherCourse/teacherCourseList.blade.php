    ...
    <div class="main-content" ms-controller="teachercommentdetail">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{url('/admin/commentCourse/commentCourseList')}}">辅导课程</a>
                </li>
                <li class="active">辅导课程列表</li>
            </ul><!-- .breadcrumb -->
                                        ...
                                        <td>
                                            <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                ...
                                                <span class="btn btn-xs btn-primary" style="position: relative;display: inline-block;">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-inverse" style="min-width: 85px;font-size:12px;color: #000;">
