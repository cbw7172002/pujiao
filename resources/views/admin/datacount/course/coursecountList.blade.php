    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{url('/admin/datacount/coursecountList')}}">数据统计</a>
                </li>
                <li class="active">课程历史统计</li>
            </ul>
        </div><!-- .breadcrumbs -->
        ...
        <div class="page-content">
            ...
            <div class="nav-search" id="nav-search">
                <form action="" method="get" class="form-search">
                    <select  id="type" name="type" id="form-field-1" class="searchtype">
                        ...
                        <option value="2" @if($data->type == 1) selected @endif>课程名称</option>
                        <option value="3" @if($data->type == 2) selected @endif>授课教师</option>
                    </select>
            ...
            @if(count($excel))
                <form action="{{url('admin/excel/coursehistCountExport')}}" method="post" style="float: left;">
