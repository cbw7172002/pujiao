        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="{{url('admin/baseInfo/doAddClass')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select name="parentId" id="form-field-1" class="col-xs-10 col-sm-5">
                                    ...
                                    @foreach($data as $d)
                                        <option value="{{$d->id}}">{{$d->gradeName}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input  type="text" name="classname" id="form-field-1" placeholder="班级名称" class="col-xs-10 col-sm-5" value="{{old
                                ('url')
                                }}" />
