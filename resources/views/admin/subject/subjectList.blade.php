    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{url('/admin/subject/subjectList')}}">科目管理</a>
                </li>
            ...
            <div class="nav-search" id="nav-search">
                <form action="" method="get" class="form-search">
                    ...
                    <select name="type" id="form-field-1" class="searchtype">
                        ...
                        <option value="2" @if($data->type == 2) selected @endif>科目名称</option>
        ...
        <div class="page-content">
            ...
            @permission('add.subject')
                <a href="{{url('/admin/subject/addsubject')}}" class="btn btn-xs btn-info">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    ...
                                                    <a href="{{url('/admin/subject/editsubject/'.$d->id)}}" class="btn btn-xs btn-info">
                                                        <i class="icon-edit bigger-120"></i>
                                                    </a>
                                                    @endpermission


                                                    @permission('del.subject')
                                                    <a href="{{url('/admin/subject/delsubject/'.$d->id)}}" style="width:29px" class="btn btn-xs btn-danger" onclick="return confirm('删除后将无法找回,确定要删除吗?');">
