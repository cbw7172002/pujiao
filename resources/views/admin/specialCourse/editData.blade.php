                ...
                <div class="col-xs-12">
                    ...
                    <div class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" re name="dataName" id="ttitle" placeholder="资料名称" class="col-xs-10 col-sm-5" ms-duplex="dataName" />
...
@section('js')
    <script>
        require(['/specialCourse/editData'], function (upload) {
...
//                            var filenameno = filename.substring(0,filename.lastIndexOf('.'));
            ...
            upload.courseId = '{{ $data->courseId }}' || null;
            upload.id = '{{ $data->id }}' || null;
            upload.dataName = '{{ $data->dataName }}' || null;
            upload.uploadInfo.low.fileID = '{{ $data->fileID }}' || null;
            upload.uploadInfo.low.FileLenth = '{{ $data->size }}' || null;
            upload.uploadInfo.low.courseLowPath = '';
            {{--upload.uploadInfo.low.courseMediumPath = '{{ $data->courseMediumPath }}' || null;--}}
            {{--upload.uploadInfo.low.courseHighPath = '{{ $data->courseHighPath }}' || null;--}}
