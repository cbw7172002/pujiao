define(['evaluateManageTea/async', 'teacherCourse/create'], function (async, create) {
            ...
            vm.request('/evaluateManageTea/publishPaper', data, function (err, res) {
                ...
                if (err) {
                    ...
                    switch (vm.createType) {
                        case 1:
                            create.testIda = res;
                            create.testTitlea = vm.title;
                            break;
                        case 2:
                            create.testIdb = res;
                            create.testTitleb = vm.title;
                            break;
                        case 3:
                            create.testIdc = res;
                            create.testTitlec = vm.title;
                            break;
                    }
                    create.papertype = vm.quesStyle,
                    create.submitTime = vm.pickdate + ' ' + $('#picktime').val() + ':00',
                    create.completeTime = vm.completeTime,
                    $('.content_right_papercourse').hide();
