...
avalon.directive('baiduditu', {
	update: function (value) {
		...
		//标注点数组
		var markerArr = [{title:"公司地址",content:"地址：北京市海淀区硅谷亮城8号楼荣信大厦3A",point:"116.316351|40.03402",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		];
		//创建marker
		function addMarker(){
		...
		function createIcon(json){
			var icon = new BMap.Icon("http://api.map.baidu.com/img/markers.png", new BMap.Size(23,25),{imageOffset: new BMap.Size(-json.l,-json.t),infoWindowOffset:new BMap.Size(json.lb+5,1),offset:new BMap.Size(json.x,json.h)})
