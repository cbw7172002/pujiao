        ...
        submit:function(id,courseid,selectid){
            ...
            if(selectid == 1){ //选择章
                ...
                if(selectid == 2){ //选择节
                    ...
                    $.ajax({
                        type: "post",
                        data:{id:id,courseid:courseid,title:upload.title,selectid:selectid,isTrylearn:upload.isTrylearn,fileID:upload.uploadInfo.low.fileID,courseFormat:upload.suffix},
                        url: "/admin/specialCourse/doEditSpecialChapter",
