                                ...
                                if (response.data.data.AllowUpload == 2) {
                                    ...
                                    setTimeout(function() {
                                        ...
                                        if(datasize > 1024*1024){
                                            upload.uploadInfo[model].FileLenth = Math.round(datasize/1024/1024*10)/10+'M';
                                        }else if(datasize > 1024){
                                            upload.uploadInfo[model].FileLenth = Math.round(datasize/1024*10)/10+'KB';
                                        }else{
                                            upload.uploadInfo[model].FileLenth = datasize+'K';
                                        }
